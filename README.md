...
```
cd existing_repo
git remote add origin https://gitlab.estg.ipp.pt/productech/multiflow.git
git branch -M master
git push -uf origin master
```
...
- [ ] [Set up project integrations](https://gitlab.estg.ipp.pt/productech/multiflow/-/settings/integrations)
